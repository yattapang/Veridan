 ...
 * fidelity argument those numbers already satisfy. The itemized section
 * (MAJOR-2 fix) is loaded via lib/invoices/itemization.ts, DISPLAY ONLY —
 * see that file's header for the full argument.
 */
 ...
 * deposit_pct context line, the itemized breakdown, and the frozen
 * company_details footer) and renders the branded invoice PDF to a buffer.
 */
