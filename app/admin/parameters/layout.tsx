...
/**
 * Founder-only gate for /admin/parameters and every route nested under it.
 *
 ...
 */
export default async function ParametersLayout({ children }: { children: React.ReactNode }) {
  await requireFounderPage("parameters");
  return <>{children}</>;
}
