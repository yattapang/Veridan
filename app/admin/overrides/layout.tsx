...
/**
 * Founder-only gate for /admin/overrides and every route nested under it.
 *
 ...
 */
export default async function OverridesLayout({ children }: { children: React.ReactNode }) {
  await requireFounderPage("overrides");
  return <>{children}</>;
}
