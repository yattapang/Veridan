...
/**
 * Founder-only gate: this sub-view is per-door hardware-set line items, i.e. product unit costs and cost overrides.
 *
 ...
 */
export default async function HardwareSetsLayout({ children }: { children: React.ReactNode }) {
